...
| A3 | **Dodge** (defender DEX) | the finalized action is a PHYSICAL SINGLE-TARGET hit (melee slash, arrow, staff bonk — including a misfired physical attack onto an ally) | 0–(den−1) | **NEW (story 4.6)** |
| A4 | **Crit** (attacker DEX) | same condition as A3 — **always drawn, even when A3 dodged** (result discarded on a dodge) | 0–(den−1) | **NEW (story 4.6)** |
