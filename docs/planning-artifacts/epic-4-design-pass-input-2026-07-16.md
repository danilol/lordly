...
2. **Monsters / big units** — dragon, golem, etc. A monster occupies **1.5 spaces** of the 5-space budget: `1 monster + 3 smalls = 4 units`, or `2 monsters + 1 small = 3 units`. "Big" is about size-class, not theme — a zombie or fairy is monster-themed but SMALL (1 space). (OB64 reference images 1–2: large sprites sharing formation grids with small units.)
